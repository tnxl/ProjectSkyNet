            ...
            public void longClick() {
                AndPermission
                        ...
                        .onDenied(new Action<List<String>>() {
                            @Override
                            public void onAction(List<String> data) {
                                Toast.makeText(RecorderActivity.this, "录音权限获取失败", Toast.LENGTH_SHORT).show();
                            }
                        })
    ...
    private void startRec() {
        ...
        mp3Recorder = RecorderManager.getInstance(System.currentTimeMillis() + "", new RecordPermissionListener() {
            ...
            public void noRecordRight() {
                ...
                btn.setText("按住 说话");
                Toast.makeText(RecorderActivity.this, "您无录音权限", Toast.LENGTH_SHORT).show();
            }
        });
        try {
            mp3Recorder.start();
