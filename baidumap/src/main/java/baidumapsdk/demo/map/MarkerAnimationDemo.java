...
public class MarkerAnimationDemo extends Activity {
    ...
    public void startAnimation(View view) {
        int i = view.getId();
        if (i == R.id.btn_rotate) {//旋转动画
            startRotateAnimation();

        } else if (i == R.id.btn_scale) {//缩放动画
            startScaleAnimation();

        } else if (i == R.id.btn_transformation) {//平移动画
            startTransformation();

        } else if (i == R.id.btn_alpha) {//透明动画
            startAlphaAnimation();

        } else if (i == R.id.btn_singleScale) {//组合动画
            startSingleScaleAnimation();

        } else if (i == R.id.btn_animationSet) {//组合动画
            startAnimationSet();
